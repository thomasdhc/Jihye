...
- Do the work directly when briefing and verifying a subagent would cost more than finishing it. Otherwise, load and follow the `coordinate` skill before the first subagent call.
