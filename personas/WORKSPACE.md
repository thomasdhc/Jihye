...
- Read and follow the most-specific repository guidance governing the target. In each directory, resolve it in Pi's order: `AGENTS.override.md`, `AGENTS.md`, `AGENTS.MD`, `CLAUDE.md`, then `CLAUDE.MD`; use only the first file present there.
